...
extension AuthenticationService {
    ...
    private func handleSignInWithAppleCompletion(_ authorization: ASAuthorization,
        ...
        authenticationUserWithFirebase(credential: credential) { result in
            switch result {
    ...
    private func authenticationUserWithFirebase(credential: AuthCredential, completion: @escaping (Result<User, Error>) -> Void) {
