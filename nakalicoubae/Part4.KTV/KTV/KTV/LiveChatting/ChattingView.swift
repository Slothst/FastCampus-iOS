...
class ChattingView: UIView {
    ...
    private func scrollToLastestIfNeeded() {
        ...
        let isLastestMessageMine = self.viewModel.messages.last?.isMine == true
        
        if isBottomOffset || isLastestMessageMine {
    ...
    private func setupCollectionView() {
        ...
        self.collectionView.register(
            UINib(nibName: LiveChattingMessageCollectionViewCell.identifier, bundle: nil), forCellWithReuseIdentifier: LiveChattingMessageCollectionViewCell.identifier
        )
        self.collectionView.register(
            UINib(nibName: LiveChattingMyMessageCollectionViewCell.identifier, bundle: nil), forCellWithReuseIdentifier: LiveChattingMyMessageCollectionViewCell.identifier
        )
    }
}
